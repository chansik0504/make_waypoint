...
void MapCallback(const nav_msgs::OccupancyGrid& msg)
{
    ...
    for(int i=0;i<height;i++)
    {
        for(int j=0;j<width;j++)
        {
            ...
            Mappoint.push_back(Map.at<uchar>(height-i-1, j));
        }
    }
	...
	// string filePath = "/home/ryul/catkin_ws/Mapdata.txt";
    ...
    for(int i=0;i<height;i++)
    {
        for(int j=0;j<width;j++)
        {
            ...
            Maskpoint.push_back(Mask.at<uchar>(height-i-1, j) * 255);
        }
    }
	...
	// string filePath = "/home/ryul/catkin_ws/Maskdata.txt";
